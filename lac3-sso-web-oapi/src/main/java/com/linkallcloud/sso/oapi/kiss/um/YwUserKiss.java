...
import com.linkallcloud.sso.oapi.kiss.BaseKiss;
...
public class YwUserKiss extends BaseKiss {
	...
	public YwUser fecthByAccount(Trace t, String account) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/YwUser/fecthByAccount",
				sendMsgPkg);
	...
	public List<YwUser> findByMobile(Trace t, String mobile) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/YwUser/findByMobile", sendMsgPkg);
	...
	public YwUser fetchByGovCode(Trace t, String govCode) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/YwUser/fetchByGovCode",
				sendMsgPkg);
		YwUser result = unpackMessage(responseJson, new TypeReference<ObjectFaceResponse<YwUser>>() {
		});
		return result;
	...
	public YwUser fetchById(Trace t, Long id) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/YwUser/fetchById", sendMsgPkg);
		YwUser result = unpackMessage(responseJson, new TypeReference<ObjectFaceResponse<YwUser>>() {
		});
		return result;
	}
	...
	public SessionUser assembleSessionUser(Trace t, String account, String appCode) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/YwUser/assembleSessionUser",
				sendMsgPkg);
	...
	public List<Tree> getUserAppMenu(Trace t, Long userId, Long appId) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/YwUser/getUserAppMenu",
				sendMsgPkg);
	...
	public String[] getUserAppPermissions4Menu(Trace t, Long userId, Long appId) {
		...
		String responseJson = HttpClientFactory.me(false)
				.post(getUmOapiUrl() + "/face/YwUser/getUserAppPermissions4Menu", sendMsgPkg);
