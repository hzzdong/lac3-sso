...
public class ApplicationKiss extends BaseKiss {
	...
	public Application fetchByCode(Trace t, String appCode) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/Application/fetch", sendMsgPkg);
	...
	public List<Application> find(Trace t, ListFaceRequest req) {
		...
		String responseJson = HttpClientFactory.me(false).post(getUmOapiUrl() + "/face/Application/find", sendMsgPkg);
