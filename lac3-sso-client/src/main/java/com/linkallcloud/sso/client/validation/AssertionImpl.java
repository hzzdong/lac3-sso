...
public class AssertionImpl implements Assertion {
	...
	/**
	 * Map of the attributes returned by the SSO server. This is optional as the SSO
	 * server spec makes no mention of attributes.
	 */
	...
	/**
	 * Reference to ProxyRetriever so that clients can retrieve proxy tickets for a
	 * service.
	 */
	 ...
	 * @param principal             the Principal this assertion is for.
	 * @param attributes            a map of attributes about the principal.
	 * @param proxyRetriever        used to retrieve proxy tickets from SSO Server.
	 * @param proxyGrantingTicketId the Id to use to request proxy tickets.
	 */
	public AssertionImpl(final Principal principal, final Map<String, Object> attributes,
			final String proxyGrantingTicketId) {// final ProxyRetriever proxyRetriever,
