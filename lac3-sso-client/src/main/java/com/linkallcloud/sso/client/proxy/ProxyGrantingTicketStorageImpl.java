 ...
 *
 * cn.zj.pubinfo.sso.client.proxy.ProxyGrantingTicketStorageImpl.java 
 *
 * 2011-6-15
 * 
 */
...
/**
 * Implementation of {@link ProxyGrantingTicketStorage} that is backed by a HashMap that keeps a ProxyGrantingTicket for
...
public final class ProxyGrantingTicketStorageImpl implements ProxyGrantingTicketStorage {
     ...
     * (non-Javadoc)
     * 
     * @see cn.zj.pubinfo.sso.client.proxy.ProxyGrantingTicketStorage#retrieve(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see cn.zj.pubinfo.sso.client.proxy.ProxyGrantingTicketStorage#save(java.lang.String, java.lang.String)
     */
    @Override
    ...
    private final class ProxyGrantingTicketCleanupThread extends Thread {
        ...
        public ProxyGrantingTicketCleanupThread(final long timeout, final Map<String, ProxyGrantingTicketHolder> cache) {
